...
const AddCustomer = () => {
  ...
  const onChangeBillingtodelivery = (e) => {
    if (e.target.checked) {
      ...
      // deliveryAddressref.current.value = deliveryAddressref.current.value ? '' : formik.values.billingAddress;
      // postalcoderef.current.value = postalcoderef.current.value ? '' : formik.values.billingPostalCode;
      // citynameref.current.value = citynameref.current.value ? '' : formik.values.billingCityName;
      // statenameref.current.value = statenameref.current.value ? '' : formik.values.billingStateName;
  ...
  const formik = useFormik({
    initialValues: {
      ...
      // addVAT: '',
      // securityID: "",
      // activeDate: "2022-06-05",
      // deactiveDate: "2022-06-05",
      // activeStatus: "",
      // website: "",
      // message: "",
      // manualVATPercent: "",
